             ...
             <section class="app-user-list">
                 ...
                 <div class="card">
                     <div class="card-body border-bottom">
                         ...
                         <h4 class="card-title">L'ensemble des évènements des éditions PBA sont enregistrées ici.</h4>
                         <div class="row">
                         ...
                         <table class="user-list-tablje table">
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>{{ $book->status}}</td>
                                     <td>
                                         <img style="height: 40px;" src="{{asset('storage/events/'. $book->image)}}" alt="">
                                     </td>
                                     <td class="d-flex">
                                         ...
                                         <button type="button" class="btn text-primary" data-bs-toggle="modal" data-bs-target="#inlineFormDelete" wire:click="deleteEvent({{ $book->id }} )">
                     ...
                     <div class="form-modal-ex">
                             ...
                             <div class="modal-dialog modal-dialog-centered modal-lg">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h4 class="modal-title" id="myModalLabel33">Publier un évènement </h4>
                                         ...
                                         <div class="modal-body">
                                             <div class="row">
                                                 ...
                                                 <div class="col-md-6">
                                                     ...
                                                     <div class="mb-1">
                                                         <input type="date" wire:model="data_evenement" placeholder="Date de l'évènement" class="form-control" />
                                                         @error('data_evenement') <span class="text-danger"> {{ $message}} </span> @enderror
                                                     </div>
                                                 </div>
                                             ...
                                             <div class="row">
                                                 ...
                                                 <div class="col-md-6">
                                                     <label>Associer une affiche: </label>
                                                     <div class="mb-1">
                                                     ...
                                                     @elseif ($oldImage)
                                                     <img style="height: 100px;" src="{{ asset('storage/events/'.$oldImage) }}" class="w-1/2">
                                                     @endif
                                                 </div>
                                                 <div class="col-md-12">
                         ...
                         <div wire:ignore.self class="modal fade text-start" id="inlineFormDelete" tabindex="-1" aria-labelledby="myModalLabel33" aria-hidden="true">
                             <div class="modal-dialog modal-dialog-centered">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h4 class="modal-title" id="myModalLabel33">Suppression d'un évènement </h4>
                                         <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                     </div>
                                     <form wire:submit.prevent="destroyEvent" enctype="multipart/form-data">
                                         @csrf
                                         <div class="modal-body">
                                             <h4>Êtes-vous sûr de bien vouloir supprimer cet évènement?</h4>
