             ...
             <section class="app-user-list">
                 ...
                 <div class="card">
                     <div class="card-body border-bottom">
                         ...
                         <h4 class="card-title">L'ensemble des stages des éditions PBA sont enregistrées ici.</h4>
                         <div class="row">
                     ...
                     <div class="form-modal-ex">
                             ...
                             <div class="modal-dialog modal-dialog-centered modal-lg">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h4 class="modal-title" id="myModalLabel33">Publier une offre de stage </h4>
                                         ...
                                         <div class="modal-body">
                                             ...
                                             <div class="row">
                                                 <div class="col-md-6">
                                                     <label>date: </label>
                                                     <div class="mb-1">
                                                         <input type="date" wire:model="date" placeholder="date" class="form-control" />
                                                 ...
                                                 <div class="col-md-6">
                                                     <label>Heure: </label>
                                                     <div class="mb-1">
                                                         <input type="text" wire:model="heure" placeholder="heure" class="form-control" />
                         ...
                         <div wire:ignore.self class="modal fade text-start" id="inlineFormUpdate" tabindex="-1" aria-labelledby="myModalLabel33" aria-hidden="true">
                             <div class="modal-dialog modal-dialog-centered modal-lg">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h4 class="modal-title" id="myModalLabel33">Modifier l'offre de stage </h4>
                                         <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                     </div>
